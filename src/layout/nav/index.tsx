        ...
        <ul className={styled.list}>
          ...
          <li className={styled.section}>
            ...
            <ol
              ...
              onClick={() => handleOnClick('/dropdown')}
            >
              Dropdown
            </ol>
            <ol
              className={pathname === '/pagination' ? styled.active : ''}
              onClick={() => handleOnClick('/pagination')}
            >
              Pagination
            </ol>
          </li>
          ...
          <li className={styled.section}>
            ...
            <ol
              ...
              onClick={() => handleOnClick('/skeleton')}
            >
              Skeleton
            </ol>
            <ol
              className={pathname === '/spin' ? styled.active : ''}
              onClick={() => handleOnClick('/spin')}
            >
              Spin
            </ol>
            <ol
              className={pathname === '/modal' ? styled.active : ''}
              onClick={() => handleOnClick('/modal')}
            >
              Modal
            </ol>
            <ol
